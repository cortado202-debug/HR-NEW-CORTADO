        ...
        <div className="lg:col-span-8 flex flex-col gap-3.5">
          ...
          <div className="flex flex-wrap items-center justify-between gap-2 pt-2.5 border-t border-slate-100">
            ...
            <button
              ...
              className="flex-1 min-w-[170px] flex items-center justify-center gap-1.5 px-3.5 py-2 bg-slate-900 hover:bg-slate-800 active:bg-slate-950 disabled:bg-slate-300 disabled:cursor-not-allowed text-white text-xs font-bold rounded-lg shadow-xs transition-all cursor-pointer whitespace-nowrap"
            >
              <Zap className="w-3.5 h-3.5 text-emerald-400 fill-emerald-400 shrink-0" />
              {lateEvaluation.isLate ? (
                <span className="inline-flex items-center gap-1 text-xs">
                  <span>تسجيل حضور</span>
                  <span className="text-[11px] font-medium text-amber-300 bg-amber-950/70 px-1.5 py-0.5 rounded">
                    متأخر {lateEvaluation.lateMinutes} د
                  </span>
                </span>
              ) : (
                <span className="text-xs">تسجيل حضور الآن</span>
              )}
            </button>
            ...
            <button
              ...
              className="flex-1 min-w-[130px] flex items-center justify-center gap-1.5 px-3.5 py-2 bg-emerald-700 hover:bg-emerald-800 active:bg-emerald-900 disabled:bg-slate-300 disabled:cursor-not-allowed text-white text-xs font-bold rounded-lg shadow-xs transition-all cursor-pointer whitespace-nowrap"
            >
              <LogOut className="w-3.5 h-3.5 text-emerald-200 shrink-0" />
              <span className="text-xs">تسجيل انصراف</span>
            </button>
            ...
            <div className="flex items-center gap-1.5 w-full sm:w-auto">
              ...
              <button
                ...
                className="flex-1 sm:flex-none flex items-center justify-center gap-1 px-2.5 py-2 bg-emerald-50 hover:bg-emerald-100 text-emerald-800 border border-emerald-300 rounded-lg text-xs font-bold transition-colors disabled:opacity-50 cursor-pointer whitespace-nowrap"
              >
                <ClockPlus className="w-3 h-3 text-emerald-600 shrink-0" />
                <span>+إضافي</span>
              </button>
              ...
              <button
                ...
                className="flex-1 sm:flex-none flex items-center justify-center gap-1 px-2.5 py-2 bg-indigo-50 hover:bg-indigo-100 text-indigo-800 border border-indigo-200 rounded-lg text-xs font-bold transition-colors disabled:opacity-50 cursor-pointer whitespace-nowrap"
              >
                <DoorOpen className="w-3 h-3 text-indigo-600 shrink-0" />
                <span>مغادرة</span>
              </button>
              ...
              <button
                ...
                className="flex-1 sm:flex-none flex items-center justify-center gap-1 px-2.5 py-2 bg-white hover:bg-rose-50 text-rose-700 border border-rose-200 rounded-lg text-xs font-bold transition-colors disabled:opacity-50 cursor-pointer whitespace-nowrap"
              >
              ...
              <button
                ...
                className="flex-1 sm:flex-none flex items-center justify-center gap-1 px-2.5 py-2 bg-white hover:bg-sky-50 text-sky-700 border border-sky-200 rounded-lg text-xs font-bold transition-colors disabled:opacity-50 cursor-pointer whitespace-nowrap"
              >
                <SunMedium className="w-3 h-3 text-sky-500 shrink-0" />
                <span>نصف يوم</span>
              </button>
